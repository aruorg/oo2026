var Resistor3 = /** @class */ (function () {
    function Resistor3(r, g, 
    ...
    Resistor3.prototype.draw = function () {
    ...
    Resistor3.prototype.setR = function (r) {
        this.r = r;
        this.draw();
    };
    Resistor3.prototype.getR = function () {
        return this.r;
    };
    return Resistor3;
}());
